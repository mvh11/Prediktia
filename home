export default function Home() {
  return (
    <div className="bg-gray-950 text-white min-h-screen p-10">
      {/* NAVBAR */}
<nav className="bg-gray-900 border-b border-gray-800 px-10 py-4 mb-10">
  ...
  <div className="flex justify-between items-center">
    ...
    <div className="flex gap-6 text-gray-300 text-sm">
      ...
      <a className="hover:text-cyan-400 transition">Predicciones</a>
      <a className="hover:text-cyan-400 transition">Value</a>
      <a className="hover:text-cyan-400 transition">ACCA</a>
      <a className="hover:text-cyan-400 transition">Planes</a>
      <a className="hover:text-cyan-400 transition">Cuenta</a>
      <a className="hover:text-cyan-400 transition">Historial</a>
      <a className="hover:text-cyan-400 transition">Legal</a>
        ...
        <div className="relative rounded-2xl p-[2px] bg-gradient-to-r from-cyan-500 via-blue-500 to-green-400">
          ...
          <div className="relative bg-gray-900 rounded-2xl p-8">
            ...
            <div className="flex gap-4">
              ...
              <button className="px-6 py-3 rounded-xl font-semibold text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 shadow-lg shadow-cyan-500/50 hover:shadow-cyan-400/80 transition">
                Hazte Premium 👑
              </button>
